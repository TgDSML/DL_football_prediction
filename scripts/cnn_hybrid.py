...
Configured here for the Hybrid CNN model.
"""
...
class CNNTrainer:
    ...
    def _prepare_inputs(self, sequences: torch.Tensor, model_type: str) -> torch.Tensor:
        if model_type == "hybrid":
            return sequences
        raise ValueError(f"This script is configured for hybrid only, got: {model_type}")
...
def main():
    print("=" * 70)
    print("CNN Football Prediction - Hybrid CNN")
    print("=" * 70)
