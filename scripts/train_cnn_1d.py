...
MODEL_TYPE = "conv1d"   # "conv1d", "conv2d", "hybrid"
SEQUENCE_LENGTH = 5     # 3, 5, or 10
BATCH_SIZE = 32
NUM_EPOCHS = 60
LEARNING_RATE = 5e-4
DROPOUT = 0.5
...
EARLY_STOPPING_METRIC = "f1_weighted"   # "f1_weighted", "accuracy", "val_loss"
LABEL_SMOOTHING = 0.1
...
def main():
    ...
    if MODEL_TYPE == "conv1d":
        ...
        print(f"Expected input: (N, F, k) = (_, {input_channels}, {SEQUENCE_LENGTH})")
